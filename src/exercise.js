...
/* 액션 타입 정의 */
// 액션 타입은 주로 대문자로 작성
const INCREASE = "INCREASE"; // 증가
const DECREASE = "DECREASE"; // 감소
...
console.log(store.getState(reducer)); // 현재 store 안에 들어있는 상태를 조회한다
